...
const navigation = [
  { name: 'Dashboard', href: '/demo', icon: HomeIcon, current: true },
  {
          ...
          <div className="relative bg-white overflow-hidden">
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              <img
                ...
                src="https://gitlab.com/moggymog/4way/-/raw/master/public/assets/electronic_warehouse.png"
                alt=""
              />
            </div>
          </div>
