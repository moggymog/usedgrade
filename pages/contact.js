...
const offices = [
  {
    id: 1,
    city: 'Gig Harbor',
    address: ['9644 Bujacich Rd', 'Gig Harbor, WA 98332'],
  },
];
          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                Couldn't find your answers on our website. Reach out to us and
        ...
        <section aria-labelledby="offices-heading">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-lg text-warm-gray-500 max-w-3xl">
              We are centrally located in the PNW. We service all countries
              through our local port.
            </p>
